...
%pcm of each link
%t_stance
pt_x1= -Pt*cos(q2+q4+q1-(pi/2));
%pt_x1= -Pt*sin(q2+q4+q1);
pt_y1=  Pt*sin(q2+q4+q1-(pi/2));
%pt_y1=  -Pt*cos(q2+q4+q1);

%f_stance
pf_x1= -lt*cos(q2+q4+q1-(pi/2))-Pf*cos(q2+q1-(pi/2));
pf_y1=  lt*sin(q2+q4+q1-(pi/2))+Pf*sin(q2+q1-(pi/2));

%Torso
pT_x =-lt*cos(q2+q4+q1-(pi/2))-lf*cos(q2+q1-(pi/2))+PT*cos(q1);
pT_y = lt*sin(q2+q4+q1-(pi/2))+lf*sin(q2+q1-(pi/2))+PT*sin(q1);
